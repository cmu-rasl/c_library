...
typedef struct __mavlink_mocap_position_cmd_t
{
 ...
 int16_t heading; /*< Reference heading in rad/10^4*/
 uint8_t target_system; /*< Target system*/
} mavlink_mocap_position_cmd_t;

#define MAVLINK_MSG_ID_MOCAP_POSITION_CMD_LEN 35
#define MAVLINK_MSG_ID_217_LEN 35

#define MAVLINK_MSG_ID_MOCAP_POSITION_CMD_CRC 215
#define MAVLINK_MSG_ID_217_CRC 215
...
#define MAVLINK_MESSAGE_INFO_MOCAP_POSITION_CMD { \
	...
	{  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_mocap_position_cmd_t, time_usec) }, \
         ...
         { "heading", NULL, MAVLINK_TYPE_INT16_T, 0, 32, offsetof(mavlink_mocap_position_cmd_t, heading) }, \
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 34, offsetof(mavlink_mocap_position_cmd_t, target_system) }, \
         } \
}
 ...
 * @param heading Reference heading in rad/10^4
...
static inline uint16_t mavlink_msg_mocap_position_cmd_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint64_t time_usec, uint8_t target_system, const int16_t *pos, const int16_t *vel, const int16_t *acc, const int16_t *jerk, int16_t heading)
{
...
static inline void mavlink_msg_mocap_position_cmd_send(mavlink_channel_t chan, uint64_t time_usec, uint8_t target_system, const int16_t *pos, const int16_t *vel, const int16_t *acc, const int16_t *jerk, int16_t heading)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_MOCAP_POSITION_CMD_LEN];
	_mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_mocap_position_cmd_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, uint8_t target_system, const int16_t *pos, const int16_t *vel, const int16_t *acc, const int16_t *jerk, int16_t heading)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return Reference heading in rad/10^4
 */
static inline int16_t mavlink_msg_mocap_position_cmd_get_heading(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mocap_position_cmd_decode(const mavlink_message_t* msg, mavlink_mocap_position_cmd_t* mocap_position_cmd)
{
	...
	mocap_position_cmd->heading = mavlink_msg_mocap_position_cmd_get_heading(msg);
