...
#define MAVLINK_MSG_ID_CASCADED_CMD_GAINS_LEN 32
#define MAVLINK_MSG_ID_212_LEN 32

#define MAVLINK_MSG_ID_CASCADED_CMD_GAINS_CRC 93
#define MAVLINK_MSG_ID_212_CRC 93
...
static inline uint16_t mavlink_msg_cascaded_cmd_gains_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint64_t time_usec, const float *kR, const float *kOm)
{
...
{
	return mavlink_msg_cascaded_cmd_gains_pack(system_id, component_id, msg, cascaded_cmd_gains->time_usec, cascaded_cmd_gains->kR, cascaded_cmd_gains->kOm);
}
...
{
	return mavlink_msg_cascaded_cmd_gains_pack_chan(system_id, component_id, chan, msg, cascaded_cmd_gains->time_usec, cascaded_cmd_gains->kR, cascaded_cmd_gains->kOm);
}
...
static inline void mavlink_msg_cascaded_cmd_gains_send(mavlink_channel_t chan, uint64_t time_usec, const float *kR, const float *kOm)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_CASCADED_CMD_GAINS_LEN];
	_mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_cascaded_cmd_gains_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, const float *kR, const float *kOm)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
