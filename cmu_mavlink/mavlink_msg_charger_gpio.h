						       ...
						       uint64_t time_usec, uint8_t target_system, uint8_t on)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_CHARGER_GPIO_LEN, MAVLINK_MSG_ID_CHARGER_GPIO_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_CHARGER_GPIO_LEN);
#endif
}
						           ...
						           uint64_t time_usec,uint8_t target_system,uint8_t on)
{
	...
	msg->msgid = MAVLINK_MSG_ID_CHARGER_GPIO;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_CHARGER_GPIO_LEN, MAVLINK_MSG_ID_CHARGER_GPIO_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_CHARGER_GPIO_LEN);
#endif
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CHARGER_GPIO, buf, MAVLINK_MSG_ID_CHARGER_GPIO_LEN, MAVLINK_MSG_ID_CHARGER_GPIO_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CHARGER_GPIO, buf, MAVLINK_MSG_ID_CHARGER_GPIO_LEN);
#endif
#else
	mavlink_charger_gpio_t packet;
	packet.time_usec = time_usec;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CHARGER_GPIO, (const char *)&packet, MAVLINK_MSG_ID_CHARGER_GPIO_LEN, MAVLINK_MSG_ID_CHARGER_GPIO_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CHARGER_GPIO, (const char *)&packet, MAVLINK_MSG_ID_CHARGER_GPIO_LEN);
#endif
#endif
}
...
#else
	memcpy(charger_gpio, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_CHARGER_GPIO_LEN);
#endif
}
